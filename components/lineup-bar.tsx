...
export default function LineupBar({ reorderable, isMobile }: TLineupBar) {
  ...
  return (
    <nav className="z-700 pt-6 sm:pt-6 h-40 sm:h-27 pb-5 fixed sm:absolute w-full bottom-0 sm:bottom-0  flex flex-col-reverse sm:flex-row gap-2 sm:gap-5 items-center justify-end sm:justify-center ">
      {isMobile && (
